...
$columns = array( 
    ...
    array( 'db' => 'ds_terima_date_time',  'dt'     => 2 ), 
    array( 
        'db'        => 'ds_status', 
        'dt'        => 3, 
        'formatter' => function( $d, $row ) { 
            ...
            ($d == 1 ? "<span class='badge badge-secondary'>Antiran Servis Masuk</span>" : 
    ...
    array( 'db' => 'ds_ambil_date_time',      'dt'  => 4 )
); 
...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "ds_customer_id = $id && ds_cabang = $cabang " )

              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    $total      = 0;
	                  $i          = 1; 
	                  $queryProduct = $conn->query("SELECT penjualan.penjualan_id, penjualan.barang_qty, penjualan.penjualan_invoice, penjualan.barang_qty_lama, penjualan.barang_option_sn, penjualan.barang_sn_id, penjualan.barang_sn_desc, penjualan.keranjang_harga_beli, penjualan.keranjang_harga, penjualan.penjualan_cabang, barang.barang_id, barang.barang_nama, barang.barang_harga, barang.barang_stock, barang.barang_terjual
	                             FROM penjualan 
                          ...
                          <tr>
                              ...
                              <td class="table-nominal ">
                                <span>Rp.</span>
                                 <span>
                                  <?php 
                                    $kembali = $invoice['invoice_bayar'] - $total
                                  ?>
...
<script>
  $(".nav-link").on("click", function (){
      alert("Anda WAJIB MENYELESAIKAN Edit Invoice dengan klik tombol EDIT PAYMENT !!!");
  });
</script>

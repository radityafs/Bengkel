<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <?php if ( $levelLogin === "super admin" && $sessionCabangParent < 1 ) { ?>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a href="antrian-servis" target="_blank" class="nav-link">Antrian Servis <i class="fa fa-desktop"></i>
        </a>
      </li>
      <li class="nav-item">

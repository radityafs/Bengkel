...
$table = <<<EOT
 (
    SELECT 
      ...
      a.ds_teknisi,
      a.ds_garansi,
      a.ds_garansi_date_time,
      a.ds_garansi_komplain_date,
      a.ds_cabang,
      b.customer_id,
      b.customer_nama,
      c.user_id,
...
$columns = array( 
    ...
    array( 'db' => 'ds_garansi_date_time',  'dt'               => 6 )
); 
...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "ds_status = 9 && ds_garansi_komplain_date > 0 && ds_cabang = $cabang " )

...
?>
  ...
  <div class="content-wrapper">
    ...
    <?php  
    	$data = query("SELECT * FROM user WHERE user_cabang = $id && user_id > 1 && user_status < 1 ORDER BY user_id DESC");
    ?>
    <!-- Main content -->
                ...
                <tr>
                    ...
                    <td class="orderan-online-button">
                      ...
                      ?>
                    	...
                    	<a href="user-zoom?id=<?= base64_encode($idUser); ?>&cabang=<?= base64_encode($id); ?>" title="Zoom Data">

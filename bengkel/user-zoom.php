                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="user_gaji_pokok" class="form-control" id="user_gaji_pokok" value="<?= number_format($user['user_gaji_pokok'], 0, ',', '.'); ?>" readonly>
                        </div>
                        <div class="form-group">
                          <label for="user_bonus">Bonus Bulan <?= date("F"); ?></label>
                          <input type="text" name="user_bonus" class="form-control" id="user_bonus" value="<?= number_format($user['user_bonus'], 0, ',', '.'); ?>" readonly>
                        </div>
                        <?php /* if ( $user['user_level'] === "teknisi" ) { ?>
                        <div class="form-group">
                          <label for="user_komisi_teknisi">Komisi (%)</label>
                          <input type="text" name="user_komisi_teknisi" class="form-control" id="user_komisi_teknisi" value="<?= $user['user_komisi_teknisi']; ?>" readonly>
                        </div>
                        <?php } */?>
                        <div class="form-group">

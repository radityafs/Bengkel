      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="tambah-data">
            <a href="toko-add" class="btn btn-primary">Tambah Cabang Bengkel</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>No.</th>
                    <th style="text-transform: capitalize; width: 30%;">Nama Bengkel</th>
                    <th>Cabang</th>
...
<?php else: ?>
  <?php  
    // menari id toko
    $toko_id = mysqli_query($conn, "SELECT toko_id FROM toko WHERE toko_cabang = $sessionCabang ");
    $toko_id = mysqli_fetch_array($toko_id);
    $toko_id = $toko_id['toko_id'];

    echo "
      <script>
        document.location.href = 'toko-edit?id=".base64_encode($toko_id)."';
      </script>
    ";
  ?>
<?php endif; ?>

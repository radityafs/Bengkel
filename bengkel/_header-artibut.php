<?php 
    ...
    $userLoginCabang     = mysqli_query( $conn, "select user_cabang, user_cabang_parent from user where user_id = '".$_SESSION['user_id']."'");
    $sessionCabangData   = mysqli_fetch_array($userLoginCabang); 
    $sessionCabangParent = $sessionCabangData['user_cabang_parent'];
